...
function ultrapm_search_result_page_callback(){
    ...
    // jika ada dan tidak kosong dan tidak lebih dari 10 menit dari sekarang
    //if($datathemeenc && $datapluginenc && (time() - get_option('ultrapm_result_datatheme_time_' . $keywords) < 600) && (time() - get_option('ultrapm_result_dataplugin_time_' . $keywords) < 600)){
    ...
    // Fungsi pembanding untuk mengurutkan berdasarkan rating
    ...
    $countPlugins = 0; // Inisialisasi variabel hitungan
    ?>
    <div id="the-list">
    <?php
            ...
            <div class="plugin-cardz-bottom">
                <div class="vers column-rating">
                    <div class="star-rating">
                        ...
                        // if activeInstall more than 1 million, convert to million
                ...
                <div class="column-downloaded">
                    <strong>Active Installations:</strong> <?php echo $activeInstall; ?>
                </div>
                                    ...
                                    success: function(data) {
                                        ...
                                        if (status == true) {
                                            Swal.fire({
                                                ...
                                                // change spin to install, enable button
                                                var button = document.getElementById('delete-<?php echo $pluginSlug; ?>');
                                                button.innerHTML = 'Install & Activate';
                                                button.disabled = false;
                                                // change ID to install
                                                button.id = 'install-<?php echo $pluginSlug; ?>';
                                                // change onclick to install
                                                ...
                                                // add install only button after add to list button
        ...
        <script>
            ...
            function TakeActionSR(slug, type, name, download_url){
                // swall with 3 buttons, add to list, install, cancel
                Swal.fire({
                    title: 'Take Action',
            ...
            function TakeActionA(slug) {
                // swall with 3 buttons, Activate, Delete, Cancel
                Swal.fire({
                    title: 'Take Action',
